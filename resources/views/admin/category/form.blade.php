<div class="row">
  ...
  <div class="col-8">
    ...
    {!!Form::text('name', 'Danh mục')->placeholder('Danh mục')!!}
    {!!Form::textarea('slug', 'Thể loại')->placeholder('Thể loại')!!}
    ...
    <div class="btn-groups">
      <a class="btn btn-danger btn-sm" href="{{route('admin.category')}}">Huỷ bỏ</a>
